...
go-swagger releases are distributed as binaries that are built from signed tags. It is published [as github release](https://github.com/rws-github/go-swagger/tags),
...
```
brew tap rws-github/go-swagger
...
<https://github.com/rws-github/go-swagger/releases/latest>

```
download_url=$(curl -s https://api.github.com/repos/rws-github/go-swagger/releases/latest | \

...
```
± ~/go/src/github.com/rws-github/go-swagger/examples/tutorials/todo-list
...
```
± ~/go/src/github.com/rws-github/go-swagger/examples/tutorials/todo-list/server-1
...
```
± ~/go/src/github.com/rws-github/go-swagger/examples/tutorials/todo-list/server-2
git:(master) ✗ !? » swagger validate ./swagger.yml
The swagger spec at "./swagger.yml" is valid against swagger specification 2.0
```
...
The other 3 handler implementations are similar to this one. They are provided in the [source for this tutorial](https://github.com/rws-github/go-swagger/blob/master/examples/tutorials/todo-list/server-complete/restapi/configure_todo_list.go).
...
```
```
± ~/go/src/github.com/rws-github/go-swagger/examples/tutorials/todo-list/server-complete
```
```http
...
{"code":415,"message":"unsupported media type \"application/x-www-form-urlencoded\", only [application/io.goswagger.examples.todo-list.v1+json] are allowed"}                                                                                                     ± ~/go/src/github.com/rws-github/go-swagger/examples/tutorials/todo-list/server-complete
```
```

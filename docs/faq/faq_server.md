...
Originally from issue [#1085](https://github.com/rws-github/go-swagger/issues/1085).
...
Originally from issue [#1036](https://github.com/rws-github/go-swagger/issues/1036).
...
eg.: https://github.com/rws-github/go-swagger/blob/master/examples/authentication/restapi/configure_auth_sample.go#L33
...
Originally from issue [#762](https://github.com/rws-github/go-swagger/issues/762).
...
Originally from issue [#1005](https://github.com/rws-github/go-swagger/issues/1005). *(comes with a sample main.go for spec composition)*.
...
Originally from issue [#661](https://github.com/rws-github/go-swagger/issues/661).
...
https://github.com/rws-github/go-swagger/blob/master/generator/templates.go#L61-L73
...
There is some documentation on the config file format here: https://github.com/rws-github/go-swagger/blob/gen-layout-configfile/docs/use/template_layout.md
...
Originally from issue [#305](https://github.com/rws-github/go-swagger/issues/305).
...
Originally from issue [#1217](https://github.com/rws-github/go-swagger/issues/1217).
...
Originally from issue [#1383](https://github.com/rws-github/go-swagger/issues/1383).
...
**Answer**: see the current list of supported media MIMEs [here](https://github.com/rws-github/go-swagger/blob/3099f611ada66d42974160ac4e0ec475d24b7041/generator/support.go#L279)
You can add more through the consumer producer mechanism.

Originally from issue [#1022](https://github.com/rws-github/go-swagger/issues/1022).
...
Originally from issue [#1060](https://github.com/rws-github/go-swagger/issues/1060).

...
Originally from issue [#787](https://github.com/rws-github/go-swagger/issues/787).
...
Originally from issue [#719](https://github.com/rws-github/go-swagger/issues/719).

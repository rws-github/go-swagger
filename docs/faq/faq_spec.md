...
https://github.com/rws-github/go-swagger/tree/master/fixtures/goparsing/petstore
...
Originally from issue [#213](https://github.com/rws-github/go-swagger/issues/213).
...
Originally from issue [#68](https://github.com/rws-github/go-swagger/issues/68).
...
Originally from issue [#960](https://github.com/rws-github/go-swagger/issues/960).
...
```
Originally from issue [#1003](https://github.com/rws-github/go-swagger/issues/1003).
...
https://github.com/rws-github/go-swagger/blob/master/fixtures/goparsing/petstore/rest/handlers/orders.go#L24-L46
...
Originally from issue [#668](https://github.com/rws-github/go-swagger/issues/668).
...
Originally from issue [#561](https://github.com/rws-github/go-swagger/issues/561).
...
**Answer**: yes, it's all in there (or directly in the repo: https://github.com/rws-github/go-swagger/tree/master/docs/generate/spec)
...
https://github.com/rws-github/go-swagger/tree/master/examples/todo-list

And also: https://github.com/rws-github/go-swagger/tree/master/fixtures/goparsing/classification
...
Originally from issue [#599](https://github.com/rws-github/go-swagger/issues/599).
...
Originally from issue [#407](https://github.com/rws-github/go-swagger/issues/407).
...
Originally from issue [#47](https://github.com/rws-github/go-swagger/issues/47).
-->
<!-- Obsolete / Not helpfu
...
Originally from issue [#400](https://github.com/rws-github/go-swagger/issues/400).
-->

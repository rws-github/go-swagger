...
Originally from issue [#636](https://github.com/rws-github/go-swagger/issues/636).
...
Originally from issue [#554](https://github.com/rws-github/go-swagger/issues/554).

### What is the proper way to vendor go-swagger?
Originally from issue [#730](https://github.com/rws-github/go-swagger/issues/730).
-->

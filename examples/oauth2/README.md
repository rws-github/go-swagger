...
![Google api screenshot](https://github.com/rws-github/go-swagger/blob/master/examples/oauth2/img/google-api.png)
...
[example_code]: https://github.com/rws-github/go-swagger/blob/master/examples/oauth2/

...
import (
	...
	"github.com/rws-github/go-swagger/examples/tutorials/custom-server/gen/restapi"
	"github.com/rws-github/go-swagger/examples/tutorials/custom-server/gen/restapi/operations"
)

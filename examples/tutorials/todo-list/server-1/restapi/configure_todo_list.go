...
import (
	...
	"github.com/rws-github/go-swagger/examples/tutorials/todo-list/server-1/restapi/operations"
	"github.com/rws-github/go-swagger/examples/tutorials/todo-list/server-1/restapi/operations/todos"
)

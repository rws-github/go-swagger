...
import (
	...
	"github.com/rws-github/go-swagger/examples/tutorials/todo-list/server-complete/models"
	"github.com/rws-github/go-swagger/examples/tutorials/todo-list/server-complete/restapi/operations"
	"github.com/rws-github/go-swagger/examples/tutorials/todo-list/server-complete/restapi/operations/todos"
)

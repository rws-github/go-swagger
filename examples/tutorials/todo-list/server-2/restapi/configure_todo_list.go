...
import (
	...
	"github.com/rws-github/go-swagger/examples/tutorials/todo-list/server-2/restapi/operations"
	"github.com/rws-github/go-swagger/examples/tutorials/todo-list/server-2/restapi/operations/todos"
)

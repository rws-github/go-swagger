...
func classifierProgram() *loader.Program {
	...
	ldr.ImportWithTests("github.com/rws-github/go-swagger/fixtures/goparsing/classification")
	ldr.ImportWithTests("github.com/rws-github/go-swagger/fixtures/goparsing/classification/models")
	ldr.ImportWithTests("github.com/rws-github/go-swagger/fixtures/goparsing/classification/operations")
	prog, err := ldr.Load()
	if err != nil {
		log.Fatal(err)
	}
...
func petstoreProgram() *loader.Program {
	...
	ldr.ParserMode = goparser.ParseComments
	ldr.Build = &gobuild.Default
	ldr.ImportWithTests("github.com/rws-github/go-swagger/fixtures/goparsing/petstore")
	ldr.ImportWithTests("github.com/rws-github/go-swagger/fixtures/goparsing/petstore/models")
	ldr.ImportWithTests("github.com/rws-github/go-swagger/fixtures/goparsing/petstore/rest/handlers")
	prog, err := ldr.Load()
	if err != nil {
		log.Fatal(err)
	}
...
func invalidProgram(name string) *loader.Program {
	var ldr loader.Config
	ldr.ParserMode = goparser.ParseComments
	ldr.ImportWithTests("github.com/rws-github/go-swagger/fixtures/goparsing/" + name)
	prog, err := ldr.Load()
	if err != nil {
		log.Fatal(err)
	}
...
func TestClassifierInclude(t *testing.T) {
	...
	classifier := &programClassifier{
		Includes: packageFilters([]packageFilter{
			{Name: "github.com/rws-github/go-swagger/fixtures/goparsing/classification"},
			{Name: "github.com/rws-github/go-swagger/fixtures/goparsing/classification/transitive/mods"},
			{Name: "github.com/rws-github/go-swagger/fixtures/goparsing/classification/operations"},
			{Name: "github.com/rws-github/go-swagger/fixtures/goparsing/classification/operations_annotation"},
		}),
	}
	classified, err := classifier.Classify(prog)
	assert.NoError(t, err)
